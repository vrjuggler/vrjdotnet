...
{
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord3dAxisAngle* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____Coord__0()
   {
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord3dAxisAngle* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____Coord__gmtl_Coord3dAxisAngle1(const gmtl::Coord3dAxisAngle* p0)
   {
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord3dAxisAngle* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____Coord__gmtl_Vec3d_gmtl_AxisAngled2(const gmtl::Vec3d* p0, const gmtl::AxisAngled* p1)
   {
...
/*
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord3dAxisAngle* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____Coord__double_double_double_double_double_double6(double p0, double p1, double p2, double p3, double p4, double p5)
   {
...
*/
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord3dAxisAngle* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____Coord__double_double_double_double_double_double_double7(double p0, double p1, double p2, double p3, double p4, double p5, double p6)
   {
...
/*
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord3dAxisAngle* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____Coord__double_double_double_double_double_double_double_double8(double p0, double p1, double p2, double p3, double p4, double p5, double p6, double p7)
   {
...
*/
   ...
   SHARPPY_API gmtl::Vec3d* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____getPos__0(gmtl::Coord3dAxisAngle* self_)
   {
      gmtl::Vec3d* result;
   ...
   SHARPPY_API gmtl::AxisAngled* gmtl_Coord_gmtl_Vec_double_3__gmtl_AxisAngle_double____getRot__0(gmtl::Coord3dAxisAngle* self_)
   {
