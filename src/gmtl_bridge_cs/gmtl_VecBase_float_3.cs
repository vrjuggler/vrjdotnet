...
public class VecBase_float_3
{
   ...
   private extern static IntPtr gmtl_VecBase_float_3__VecBase__0();

   public VecBase_float_3()
   {
      mRawObject   = gmtl_VecBase_float_3__VecBase__0();
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_float_3__VecBase__gmtl_VecBase_float_31([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(gmtl.VecBase_float_3Marshaler))] gmtl.VecBase_float_3 p0);

   public VecBase_float_3(gmtl.VecBase_float_3 p0)
   {
      mRawObject   = gmtl_VecBase_float_3__VecBase__gmtl_VecBase_float_31(p0);
      mWeOwnMemory = true;
   }
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_VecBase_float_3__getData__0(IntPtr obj,
	[In, Out] float[] arrayHolder);

   public  float[] getData()
   {
      float[] array_holder = new float[3];
      gmtl_VecBase_float_3__getData__0(mRawObject, array_holder);
      return array_holder;
   }
...
public class VecBase_float_3Marshaler : ICustomMarshaler
{
   ...
   {
      return ((gmtl.VecBase_float_3) obj).RawObject;
   }
