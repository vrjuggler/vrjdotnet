...
public sealed class Matrix33f
{
   ...
   private extern static IntPtr gmtl_Matrix_float_3_3__Matrix__0();

   public Matrix33f()
   {
      mRawObject   = gmtl_Matrix_float_3_3__Matrix__0();
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Matrix_float_3_3__Matrix__gmtl_Matrix33f1([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(gmtl.Matrix33fMarshaler))] gmtl.Matrix33f p0);

   public Matrix33f(gmtl.Matrix33f p0)
   {
      mRawObject   = gmtl_Matrix_float_3_3__Matrix__gmtl_Matrix33f1(p0);
      mWeOwnMemory = true;
   }
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_Matrix_float_3_3__set__float_float_float_float_float_float_float_float_float9(IntPtr obj,
	float p0,
	float p1,
	float p2,
	float p3,
   ...
   {
      gmtl_Matrix_float_3_3__set__float_float_float_float_float_float_float_float_float9(mRawObject, p0, p1, p2, p3, p4, p5, p6, p7, p8);
   }
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_Matrix_float_3_3__getData__0(IntPtr obj,
	[In, Out] float[] arrayHolder);

   public  float[] getData()
   {
      float[] array_holder = new float[9];
      gmtl_Matrix_float_3_3__getData__0(mRawObject, array_holder);
      return array_holder;
   }


   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static bool gmtl_Matrix_float_3_3__isError__0(IntPtr obj);

   public  bool isError()
   {
      bool result;
      result = gmtl_Matrix_float_3_3__isError__0(mRawObject);
      return result;
   }


   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_Matrix_float_3_3__setError__0(IntPtr obj);

   public  void setError()
   {
      gmtl_Matrix_float_3_3__setError__0(mRawObject);
   }
