...
#define __GADGET_TYPEDPROXY_GADGET__ANALOG_ADAPTER__

#include "sharppy.h"
#include <gadget/Type/Analog.h>
#include <gadget/Type/Proxy.h>

class SHARPPY_API gadget_TypedProxy_gadget__Analog_Adapter : public gadget::TypedProxy<gadget::Analog>
{
public:
   gadget_TypedProxy_gadget__Analog_Adapter()
      : gadget::TypedProxy<gadget::Analog>()
   {;}
